...
class MerchandisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchandise" do
    assert_difference('Merchandise.count') do
      post merchandises_url, params: { merchandise: { name: @merchandise.name, purchase_price: @merchandise.purchase_price, sell_price: @merchandise.sell_price } }
    end
  ...
  test "should update merchandise" do
    patch merchandise_url(@merchandise), params: { merchandise: { name: @merchandise.name, purchase_price: @merchandise.purchase_price, sell_price: @merchandise.sell_price } }
